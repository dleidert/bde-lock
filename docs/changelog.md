...
## <date datetime="2019-02-19">[bdelock 0.0.4](https://github.com/dleidert/bde-lock/releases/tag/v0.0.4)</date> ([changes](https://github.com/dleidert/bde-lock/compare/v0.0.3...v0.0.4#files_bucket "Compare changes between release versions 0.0.3 and 0.0.4"))
